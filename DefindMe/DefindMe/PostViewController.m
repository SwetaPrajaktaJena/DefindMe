...
@interface PostViewController ()<SWRevealViewControllerDelegate,AVAudioPlayerDelegate>
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.headerLabel.text=[[titleArray objectAtIndex:indexPath.row]objectForKey:@"title"];
       self.strMedia=@"MEDIA:2";
    NSLog(@"*****%@",[[self.titleArray objectAtIndex:indexPath.row]objectForKey:@"posters"]);
     
   NSString * strUrl=[[[self.iconImageArray objectAtIndex:indexPath.row]objectForKey:@"posters"]objectForKey:@"thumbnail"];
    ...
    if (bulMusic) {
        cell.headerLabel.text=[[titleArray objectAtIndex:indexPath.row]objectForKey:@"trackName"];
        NSScanner *scanner = [NSScanner scannerWithString:[[titleArray objectAtIndex:indexPath.row]objectForKey:@"releaseDate"]];
        ...
        NSString * strNAME=[[self.titleArray objectAtIndex:indexPath.row]objectForKey:@"artistName"];
        ...
        NSString * strUrl=[[self.titleArray objectAtIndex:indexPath.row]objectForKey:@"artworkUrl60"];
    ...
    if (bulBooks) {
        ...
        cell.headerLabel                                                                                                                                                                                                                                                                                                             .text=[[[titleArray objectAtIndex:indexPath.row]objectForKey:@"volumeInfo"]objectForKey:@"title"];
        ...
        cell.timeLabel.text=result;
        NSString * strUrl=[[[[self.titleArray objectAtIndex:indexPath.row]objectForKey:@"volumeInfo" ] objectForKey:@"imageLinks"]objectForKey:@"smallThumbnail"];
...
- (void)buttonPressedAction:(UIButton *)sender{
    if (bulMusic) {
    self.strAudioUrl=[[self.titleArray objectAtIndex:sender.tag]objectForKey:@"previewUrl"];
